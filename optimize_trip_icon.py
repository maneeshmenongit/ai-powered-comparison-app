#!/usr/bin/env python3
"""
Optimize trip icon for navigation
"""
from PIL import Image
import os

input_path = 'frontend/assets/images/trip_icon_original.png'
output_path = 'frontend/assets/images/trip_icon.png'
...
if bbox:
    ...
    # Resize to navigation icon size (64px max)
    max_size = 64
